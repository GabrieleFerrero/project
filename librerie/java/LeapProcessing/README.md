...
With this library we are going to manage the inputs that the [LeapLeap](https://www.ultraleap.com/product/leap-motion-controller/) gives us back by going to draw them with processing.
