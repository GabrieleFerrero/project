public class Calcoli {
    ...
    public static final float LIMITE_X_MIN = -130;
    public static final float LIMITE_Y_MIN = 140;
    public static final float LIMITE_Z_MIN = -90;
    public static final float LIMITE_X_MAX = 130;
    public static final float LIMITE_Y_MAX = 330;
    public static final float LIMITE_Z_MAX = 90;
    ...
    public float[] getCoordPalmoProcessing(){
