...
public class Mano{
    public static final int[][] COLORE_DITA = {{0, 129, 167}, {0, 175, 185},
                                    {253, 252, 220}, {254, 217, 183}, {240, 113, 103}};
    public static final int[] COLORE_PALMO = {7, 59, 76};

    public static final int NUMERO_DITA = 5;

    private PApplet pApplet;
    private Nodo palmo;
    private Dito[] mano = new Dito[NUMERO_DITA];
    private Calcoli cl;

    Mano(PApplet pApplet, float x_schermo, float y_schermo, float z_schermo){
    ...
    public void creaMano(){
        ...
        for(int a = 0; a < this.mano.length; a++){
            this.mano[a] = new Dito(this.pApplet, COLORE_DITA[a], COLORE_DITA[a]);
        }

        //Crea e inizializza il palmo
        palmo = new Nodo(this.pApplet, COLORE_PALMO);
    ...
    public void aggiornaMano(){
        ...
        //Aggiorna il palmo
        this.palmo.aggiornaNodo(this.cl.getCoordPalmoProcessing()[0],
                this.cl.getCoordPalmoProcessing()[1],this.cl.getCoordPalmoProcessing()[2]);
        this.palmo.disegna();
    ...
    public float distanzaIndicePollice(){
        ...
        return this.cl.mapValori(distanza, 0, 300, 58, 108);
    }
}